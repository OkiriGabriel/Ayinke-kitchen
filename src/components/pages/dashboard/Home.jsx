...

                    {
                        ...
                        <>
                            <form className="mrgb1 form-search" onSubmit={(e) => e.preventDefault()}>
                                <Link onClick={(e) => toggleSearchClose(e)} className="search-close">
                                    <span className={`fe fe-x text-muted`}></span>
                                </Link>
                                <input type="text" onChange={(e) => search(e)} className="form-control search-txt" placeholder="search" />
                            </form>
                        </>
                    }
                            ...
                            <>
                                {
                                    ...
                                    (<>
                                        <div className="load--bx food-empty">
                                            ...
                                            <img src="../../../images/assets/empty@cup.svg" className="empty mrgt5" alt="empty cup" />
                                            <div className="ui-text-center pdr4 pdl4 mrgt1">
                                                <p className="onsilver">You don't have food items</p>
                                                <Link onClick={(e) => toggleAdd(e)} className="btn onwhite bg-brand-orange fs-16 mb-3">Add Food Item</Link>
                                            </div>
                                        ...
                                        eL.map(() => 
                                            <>
                                                <div className="food">
                                                    ...
                                                    <div>
                                                        <p className="title onmineshaft"><Placeholder width="180px" /></p>
                                                        <p className="mrgb0 text-muted"><Placeholder width="140px" /></p>
                                                    </div>

                                                    <div className="ml-auto ui-text-right">
                                                        <p className="title fs-15 onmineshaft"><Placeholder width="35px" /></p>
                                                        <p className={`mrgb0 onaliz`}><p className="title fs-15 onmineshaft"><Placeholder width="55px" /></p></p>
                                                    </div>
