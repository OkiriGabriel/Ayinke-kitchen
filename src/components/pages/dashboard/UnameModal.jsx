...
const UnameModal = ({isShow, closeModal, user}) => {
    ...
    const submit = async (e) => {
        ...
        if(!addData.username){
            ...
            try {
                ...
                await Axios.put(`${process.env.REACT_APP_API_URL}/users/update-username/${storage.getUserID()}`, { ...addData }, storage.getConfigWithBearer())
                .then((resp) => {

                    if(resp.data.error === false){
                        
                        setMsgData({...msgData, type: 'success', title: 'Successful!', message: 'Your username is saved', buttonText: 'Close'})
                        setStep(1);
                        refershList()
                    ...
                    <div className="d-flex">
                        ...
                        <div className="dm--body">
                            ...
                            <div className="d-flex align-items-center mrgb1">
                                <h2 className="font-gilroymedium brandcox-firefly fs-18 mrgb0">
                                    { 
                                        user && user.username &&
                                        <>Change Username</>
                                    }
                            ...
                            <div className="dm--ct">

                                {
                                    user.username &&
                                    <p>
                                        <span className="onmineshaft fs-14">Your customers to find you easily via </span>
                                        <a href={`https://checkaam.com/${user.username}`} target="_blank" className="brand-orange fs-14">www.checkaam.com/{ user.username }</a>
                                    </p>
                                }

                                {
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="mb-3 fx-ctl">
                                            ...
                                            type="text" placeholder="Add a username" className="form-control" />
                                        </div>
