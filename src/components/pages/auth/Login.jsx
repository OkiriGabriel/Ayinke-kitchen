            ...
            try {
                ...
                .then((resp) => {
                    ...
                    if(err.response.data.message === "Invalid credentials"){
                        setAData({...aData, show: true, type: 'danger', message: 'Invalid Email and Password'});
                        setTimeout(() => {
                            setAData({...aData, show: false});
                        }, 2000);
                    }
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 mx-auto">
                            ...
                            <div className="auth--bx">
                                ...
                                <div className="mrgb2">
                                    <h3 className="title fs-30 ui-text-center">Welcome Back!</h3>
                                    <p className="onsilver fs-14 ui-text-center mrgb1">Login to your account</p>
                                ...
                                <div className="form-group">
                                    ...
                                    <input 
                                    defaultValue={(e) => {setLogData({...loginData, email: e.target.value})} } 
                                    onChange={(e) => {setLogData({...loginData, email: e.target.value})}}
                                ...
                                <label>Password</label>
                                    ...
                                    <input 
                                    defaultValue={(e) => {setLogData({...loginData, password: e.target.value})} } 
