             ...
             <header id="header" className={`header ${position === true ? 'header-sticky': 'bg-brandccpurple'}`}>
                <div className="">
                    ...
                    <div className="navigation">
                        ...
                        <Link to="/" className="navbar-brand font-helveticabold fs-40 onwhite" href="">AYINKE KITCHEN</Link>
                        {/* <div>
                        ...
                        <div id="navbar-collapse" className="navbar-collapse collapse">
                            <div className="orientation">
                                ...
                                <ul className="nav navbar-nav ml-auto">
                                    ...
                                    <li className="nav-item brandccred font-gilroymedium"><Link to="/donators" className="nav-link onwhite">Food item</Link></li>
                                    {
                                        storage.checkToken() &&
