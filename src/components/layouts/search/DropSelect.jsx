...
class DropSelect extends Component {
    ...
    render(){
        return (
            <>
                <div className={`${this.props.className ? this.props.className : ''} select-box ${this.props.isDisabled ? 'disabled' : ''}`}>
                    ...
                    <div onClick={(e) => this.openMenu(e)} className="control">
                       ...
                       <div className="single">
                            ...
                            {
                                (this.state.selected.value !== '' || this.state.selected.value === '') && (this.props.defaultValue || !this.props.defaultValue) && this.props.controlDisplayLabel === true &&
                    ...
                    <div ref={this.menuRef} className={`menu ${this.state.isOpen ? 'is-open' : ''}`}>

                        {
                            ...
                            <div className="menu-search">
                                ...
                                <input ref={(input) => {this.focusInput(input)}} onChange={(e) => this.handleChange(e) } type="text" placeholder="search" className="menu-search__input"/>
                            </div>
